...
import com.foomap.util.CommentActivityGridAdapter.ViewHolder;

public class CommentNewpositionActivityGridAdapter extends BaseAdapter {
	...
	public CommentNewpositionActivityGridAdapter(Context context,List<ShowPictureInfo> mInfo) {
